# Binary Vector Generation and Minimum Graph Cover

В проекте реализованы **три алгоритма генерации полного набора бинарных векторов** и их применение для решения **задачи минимального покрытия графа** методом полного перебора.
...
В работе реализованы три алгоритма генерации бинарных векторов:
